...
func TestWhiteBoxGet(t *testing.T) {
	tr := Tree{root: node{
		value: []byte{'0'},
		children: []*node{
			&node{
...
func TestWhiteBoxSet(t *testing.T) {
	testCases := []struct {
		tree   Tree
		key    []byte
		value  interface{}
...
func TestWhiteBoxDelete(t *testing.T) {
	testCases := []struct {
		tree    Tree
		key     []byte
		deleted bool
...
func TestWhiteBoxPrettyPrint(t *testing.T) {
	testCases := []struct {
		tree Tree
		want string
	}{
...
func TestWhiteBoxCommonPrefixLength(t *testing.T) {
	testCases := []struct {
		a, b []byte
		want int
	}{
